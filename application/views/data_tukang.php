      ...
      <div class="card-header" style="background-color: #E3FDF5">
       ...
       <div class="col-md-6">
         <div class="tombol-atas">
          ...
          <a  href="<?php echo base_url('admin/halaman_tambah_user') ?>" class="btn btn-outline-info mb-4 mr-3" ><i class="fas fa-user-plus mr-1"></i>Tambah Tukang</a>
        </div>
      </div>
    </div>
  </div>
  <dic class="card-body table-responsive">
   <table class="table table-bordered table-striped table-hover" id="<?php echo $id_table ?>">
    <thead>
     <tr>
      <th width="3%">No</th>
