			...
			<section class="wrapper">
				...
				<form method="post" action="<?php echo base_url("admin/tambah_tukang") ?>">
					<div class="form-group">
						...
						<input autocomplete="off" required="" type="number" name="id_tukang" class="form-control" value="<?php echo $kode ?>">
					</div>
					<div class="form-group">
					...
					<div class="tombol-bawah">
						...
						<a href="<?php echo base_url('admin/data_tukang') ?>" class="btn btn-primary ml-2" style="width:200px">Kembali</a>
					</div>
				</form>
			</section>
		</div>
