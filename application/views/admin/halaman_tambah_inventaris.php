        ...
        <div class="card">
            ...
            <section class="wrapper">
                <div class="card-header">
                    <h3>HALAMAN TAMBAH INVENTARIS</h3>
                </div>
                <form method="post" action="<?php echo base_url("admin/tambah_inventaris") ?>">
                    <div class="form-group">
                        <label for="id_inventaris">ID Inventaris</label>
                        <input autocomplete="off" required="" type="number" name="id_inventaris" class="form-control" value="<?php echo $kode ?>">
                    </div>
                    <div class="form-group">
