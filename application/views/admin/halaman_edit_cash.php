			...
			<section class="wrapper">
				...
				<form method="post" action="<?php echo base_url("admin/edit_cash") ?>">
					...
					<div class="form-group">
						...
						<select required="" name="id_konsumen" id="id_konsumen" class="form-control">
							...
							<?php foreach ($konsumen as $ks) : ?>
								<option <?php if ($ks->id_konsumen === $cash->id_konsumen) {
											echo 'selected';
										} ?> value="<?php echo $ks->id_konsumen ?>"><?php echo $ks->nama ?></option>
							<?php endforeach ?>
						</select>
					</div>
					<div class="form-group">
					...
					<div class="form-group">
						...
						<input autocomplete="off" required="" type="number" name="total" class="form-control" value="<?php echo $cash->total ?>">
					</div>
					<div class="form-group">
